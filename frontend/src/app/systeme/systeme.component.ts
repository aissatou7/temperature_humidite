...
humidity:any = 'default';
  ...
  ngOnInit(): void {
    ...
    //console.log(data);
     this.donnee = data
     this.temperature = this.donnee[0] + this.donnee[1];//this.temperature = this.donnee[1] + this.donnee[2];
      this.humidity = this.donnee[3] + this.donnee[4];//this.humidity = this.donnee[4] + this.donnee[5];
